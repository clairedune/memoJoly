...
\newcommand{\CDKO}[2]{\textcolor{blue}{#2}} %pour liste ce qu'il reste à faire
...
Our system is made \CD{of}{by} a standard walker \CD{equipped with sensors}{on which some equipment was installed} (fig.~\ref{fig:ourrollator}):
\begin{itemize}
...
The algorithm to process Kinect images is presented in this section. The goal of the method is to segment  Kinect points cloud (see Fig.~\ref{}) in two part (left and right) which are composed by:
\begin{itemize}
