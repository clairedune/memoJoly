...
Our rollator with Kinect was tested with a person walking during two cycles of walk. A ground truth is provided by the motion capture sensor. We propose in this experiment to compute the evolution of several parameters during the walk\CJOK{: the feet angles in the Kinect frame, the angle of ankle articulation and the $z$ coordinate of the ankle.}{:
\begin{itemize}
